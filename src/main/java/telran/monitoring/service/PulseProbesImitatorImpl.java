...
public class PulseProbesImitatorImpl implements PulseProbesImitator {
	...
	public PulseProbe nextProbe() {
		...
		return new PulseProbe(patientId, System.currentTimeMillis(), ++seqNumber, value);
	}
	...
	private int getNewValue(Integer value) {
		int delta = (int) (isChance(jumpProb) ? value * jumpMultiple : value * tlr.nextDouble(0, valueMultiple));
